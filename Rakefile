...
task :samples do
  ...
  json = JSON.pretty_generate(Linguist::Samples.data)
  File.write 'lib/linguist/samples.json', json
end

task :build_gem => :samples do
  languages = JSON.parse("lib/linguist/languages.yml")
  File.write("lib/linguist/languages.json", JSON.generate(languages))
